<template>
  <div class="ion-padding">
    ...
    <p>
      These Terms of Service (“Terms”) apply to the <strong>Halal Formosa</strong> mobile application (the “Service”) provided by <strong>R Creative</strong> (the “Company”).
      By accessing or using the Service, users (“Users”) agree to be bound by these Terms.
      If you do not agree, please do not use the Service.
    </p>

    <h2>Article 1 – Acceptance of Terms</h2>
    <p>
      By using the Service, Users acknowledge that they have read, understood, and agreed to these Terms.
      If Users do not agree, they must discontinue using the Service.
    </p>

    <h2>Article 2 – Service Description and Disclaimer</h2>
    <p>The Service provides the following features:</p>
    <ul>
      <li>Barcode scanning to check halal status of products</li>
      <li>Ingredient breakdown and analysis</li>
      <li>Halal status labeling (e.g., Halal, Haram, Syubhah, Muslim-friendly)</li>
      <li>User login and authentication</li>
      <li>Product status reporting and history viewing</li>
      <li>Halal convenience map to explore nearby prayer rooms, mosques, halal restaurants, and other Muslim-friendly facilities</li>
      <li>Advertising banners to support app maintenance</li>
    </ul>
    ...
    <h2>Article 4 – User Accounts and Authentication</h2>
    <ul>
      <li>Certain features of the Service require users to <strong>create an account and log in</strong>.</li>
    ...
    <h2>Article 6 – Intellectual Property and Content Ownership</h2>
    <ol>
      ...
      <li><strong>Map and Explore Feature Content</strong>
        <ul>
          <li>The Explore / Maps feature may display content from <strong>Google Maps and other third-party services</strong>.</li>
          <li>Such content remains the <strong>property of the respective owners</strong> and is used under their licensing terms.</li>
          <li>Users must not <strong>reuse or redistribute map imagery</strong> outside the Service without authorization.</li>
        </ul>
      </li>
    </ol>

    <h2>Article 7 – Content and Report Moderation</h2>
    <ul>
      <li>All user-submitted reports may be <strong>reviewed for accuracy and compliance</strong> with these Terms.</li>
      <li>If a report appears inaccurate or incomplete, the Company may <strong>contact the user for clarification</strong>.</li>
      <li>The Company may <strong>remove reports</strong> that are clearly inaccurate, inappropriate, or violate these Terms.</li>
      <li>No legal action will be taken against users for <strong>honest mistakes</strong> in reporting.</li>
    </ul>
    ...
    <ul>
      ...
      <li>Disrupt, overload, or interfere with the Service’s infrastructure</li>
      <li>Impersonate others or misrepresent affiliation with any entity</li>
      <li>Upload malware, viruses, or other harmful content</li>
      <li>Post inappropriate, offensive, or harassing content</li>
      <li>Abuse the map feature by submitting fake locations or misleading content</li>
      <li>Spam donation requests or solicit money from other users in any form</li>
      <li>Use the Service for commercial purposes without prior written permission</li>
      <li>Engage in data scraping, automated crawling, or bot access to the Service</li>
    </ul>

    <h2>Article 10 – Modifications and Availability</h2>
    <ul>
